...
int main(int *argv, char[]*argc ){
	...
	for(int num = 0; num < t->iterTime_; num ++){
		...
		cout<<"S: "<<s<<endl<<"S_CPU: "<<s_cpu<<endl<<"====================================="<<endl;
	}
	
	float p = counter / t->iterTime_,p_cpu = counter_cpu / t->iterTime_;
	cout<<"There are "<<counter<<" S greater than the original S."<<endl;
	cout<<"P = "<<p<<endl<<"P_CPU: "<<p_cpu<<endl;
